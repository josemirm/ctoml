...
/**
 * @brief Definition of integer type and byte length
 */
#define TOML_MAX_INT_LEN 64
typedef int64_t TOMLInt_t;
...
//int getTOMLDate(TOML* t, char const* key, bool* returnValue);
//int getTOMLTime(TOML* t, char const* key, bool* returnValue);
